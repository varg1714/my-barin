...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/table5-1.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/table5-1.jpg)

为了获取存储键的服务器，我们进行求余操作 $f
  (
  k
  e
  y
  ...
  4
  =
  1$ 意味着客户端必须联系服务器1来获取缓存的数据。图5-1显示了基于表5-1的键的分布情况

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-1.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-1.jpg)

当服务器池的大小是固定的，而且数据分布均匀时，这种方法效果很好。然而，当增加新的服务器，或删除现有的服务器时，问题就会出现。

例如，如果服务器1下线了，服务器池的大小就变成了 3。使用相同的哈希函数，我们得到的键的哈希值是相同的。 但是应用求余操作，我们会得到不同的服务器索引，因为服务器的数量减少了 1。 通过应用 $h
  a
  s
  h
  mod
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/table5-2.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/table5-2.jpg)

图5-2显示了基于表5-2的新的键分布。

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-2.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-2.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-4.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-4.jpg)

#### 哈希服务器

使用相同的哈希函数 f，我们根据服务器的 IP 或名称将服务器映射到环上。 图 5-5 显示哈希环上映射了 4 个服务器

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-5.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-5.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-8.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-8.jpg)

#### 移除一台服务器

当一台服务器被移除时，只有一小部分的键需要用一致的哈希法进行重新分配。 在图5-9中，当 `server1` 被移除时，只有 `key1` 必须被重新映射到server2。 其余的键不受影响。

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-9.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-9.jpg)
...
1. 首先，考虑到可以添加或删除服务器， **不可能保持环上所有服务器的分区大小相同** 。 分区是相邻服务器之间的哈希空间。 分配给每个服务器的环上分区的大小可能非常小或相当大。在图5-10中，如果删除s1，s2的分区（用双向箭头突出显示）是s0和s3分区的两倍。
	[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-10.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-10.jpg)
2. 第二，在环上有可能出现 **不均匀的键分布** 。例如，如果服务器被映射到图5-11中所列的位置，大部分的密钥都存储在 `serve2` 上。然而， `server1` 和 `serser3` 没有数据。
	[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-11.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-11.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-12.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-12.jpg)

为了找到键存储在哪个服务器上，我们从键的位置顺时针方向找到环上遇到的第一个虚拟节点。 在图5-13中，为了找出k0存储在哪个服务器上，我们从k0的位置顺时针方向找到虚拟节点s1\_1，它就是是server1。

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-13.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-13.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-14.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-14.jpg)

如图 5-15 所示，当一个服务器（s1）被移除时，受影响的范围从 s1（被移除的节点）开始并沿环逆时针方向移动，直到找到一个服务器（s0）。 因此，位于 s0 和 s1 之间的密钥必须重新分配给 s2。

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter5/figure5-15.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter5/figure5-15.jpg)
...
[^5]: How Discord Scaled Elixir to 5,000,000 Concurrent Users:[https://blog.discord.com/scaling-elixir-f9b8e1e7c29b](https://blog.discord.com/scaling-elixir-f9b8e1e7c29b)

[^6]: CS168: The Modern Algorithmic Toolbox Lecture #1: Introduction and Consistent Hashing:[http://theory.stanford.edu/~tim/s16/l/l1.pdf](http://theory.stanford.edu/~tim/s16/l/l1.pdf)
