---
source: "https://github.com/Admol/SystemDesign/blob/main/CHAPTER%2008%EF%BC%9ADESIGN%20A%20URL%20SHORTENER.md"
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-1.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-1.jpg)

客户端和服务器之间的详细通信情况如图8-2所示。

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-2.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-2.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-3.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-3.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-4.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-4.jpg)
...
hashValue 由\[0-9, a-z, A-Z\]中的字符组成，包含 $10
  +
  26
  +
  26
  =
  62$ 个可能的字符。要计算 hashValue 的长度，请找出最小的 n，使 $62
    n
  
  ≥
  365
  亿$ 。根据估计，系统必须支持多达 3650 亿个 URL。 表 8-1 显示了 hashValue 的长度和它可以支持的相应的最大 URL 数。

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/table8-1.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/table8-1.jpg)
...
当 $n
  ...
  3.5
  万
  亿$ ，3.5 万亿足以容纳 3650亿个URL，所以 hashValue 的长度为 7。

我们将探讨两种类型的URL缩短器的哈希函数。第一种是 "哈希+碰撞解决"，第二种是 "base 62 转换"。让我们逐一来看看它们。

**哈希+碰撞解决**

为了缩短长的URL，我们应该实现一个散列函数，将长的URL散列成一个7个字符的字符串。一个直接的解决方案是使用知名的哈希函数，如CRC32、MD5或SHA-1。下表比较了在这个URL（ [https://en.wikipedia.org/wiki/Systems\_design](https://en.wikipedia.org/wiki/Systems_design) ）上应用不同哈希函数后的哈希结果：

[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/table8-2.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/table8-2.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-5.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-5.jpg)

这种方法可以消除碰撞；但是，查询数据库以检查每个请求是否存在短网址的成本很高。一种叫做 **Bloom过滤器** 的技术[^2]:可以提高性能。布隆过滤器是一种空间效率高的概率技术，用来测试一个元素是否是一个集合的成员。更多细节请参考参考资料[^2]:。

**base 62 转换**

Base 转换是 URL 缩短器常用的另一种方法。 Base 转换有助于在不同的数字表示系统之间转换成相同的数字。 使用 Base 62 转换，因为 hashValue 有 62 个可能的字符。 让我们用一个例子来解释转换的工作原理：将 $11157
    
      10$ 转换为 base 62 表示（ $11157
    
      10$ 在 base 10 系统中表示 11157）。
...
- $11157
	...
	对话过程如图8-6所示。
	[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-6.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-6.jpg)
- 因此，短网址是： [https://tinyurl.com/2TX](https://tinyurl.com/2TX)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-7.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-7.jpg)
...
- 将ID、shortURL和longURL保存到数据库，如表8-4所示。
	[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/table8-4.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/table8-4.jpg)
...
[![](https://github.com/Admol/SystemDesign/raw/main/images/chapter8/figure8-8.jpg)](https://github.com/Admol/SystemDesign/blob/main/images/chapter8/figure8-8.jpg)
