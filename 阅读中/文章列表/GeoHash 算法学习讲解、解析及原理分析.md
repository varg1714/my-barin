...
然后采用 Base32 对应编码进行转换可得到编码 **wx4g0e** 这样的可比较的字符串，比如我们的**经纬度都分了 10 次**，那么最后生成的字符串的长度就是 4，范围是 20km，如果我们**经纬度都分 20 次**，那么最后生成的字符串的长度就是 8，范围可以精确到 19m。为什么是可比较字符串，后面会详细讲解到。
